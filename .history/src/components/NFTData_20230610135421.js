...
const NFTData = () => {
    ...
    return (
        <div className='hero'>
            <div>
                <span className='crazyface__title'>CRAZYFACES</span>
            </div>
            <img className='crazyface one' src={crazyFace41} alt="crazyFace41" />
            <img className='crazyface two' src={crazyFace71} alt="crazyFace71" />
