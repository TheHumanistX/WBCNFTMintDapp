...
const RecentMints = ({ crazyFacesContractAddress, crazyFacesContract, lastID }) => {
  ...
  const recentMints = mintedToAddresses.slice(mintedToAddresses.length - 5, mintedToAddresses.length - 1);
