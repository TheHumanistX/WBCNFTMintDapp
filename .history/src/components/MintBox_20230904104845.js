...
const MintBox = () => {
  ...
  const { formattedTokenBalance, mintContract, tokenContract } = useEthers();
  // const [mintPriceBigNumber, setMintPriceBigNumber] = useState(null);
  ...
  // const mintPriceBigNumber = mintContract ? mintContract.getPrice() : null;

  // const { data: balance } = useContractRead(tokenContract, "balanceOf", [walletAddress]);
