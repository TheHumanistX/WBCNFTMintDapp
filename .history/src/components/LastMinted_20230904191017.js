        ...
        <div className='last-minted__container'>
            ...
            {nftData &&
                <>
                    ...
                    <span className='last-minted__name'><a href={'https://testnets.opensea.io/assets/goerli/0xf94a9747c20076d56f84320acf36431dae557fb7/' + (lastID - 1)}>#{lastID + 1} {nftData.name}</a></span>
                </>
            }
        </div>
    )
