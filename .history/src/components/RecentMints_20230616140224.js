...
const RecentMints = ({ crazyFacesContractAddress, lastID }) => {
    ...
    const crazyFacesContract = new ethers.Contract(crazyFacesContractAddress, abi, provider);
    ...
    return (
      ...
      <div className='transaction__list' key={index}>
        <span><a href={'https://testnets.opensea.io/assets/goerli/0xf94a9747c20076d56f84320acf36431dae557fb7/' + nftID}>CRAZYFACE #{nftID}</a></span>
